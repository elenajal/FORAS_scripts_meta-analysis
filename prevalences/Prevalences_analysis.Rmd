...
# Compute 95% CI (logit scale)
ci_Decreasinger_glmer_Decreasing <- est_glmer_Decreasing - 1.96 * se_glmer_Decreasing
...
glmer_summary_Decreasing <- data.frame(
  ...
  CI_Decreasinger = round(plogis(ci_Decreasinger_glmer_Decreasing), 3),
...
# Compute 95% CI (logit scale)
ci_Increasinger_glmer_Increasing <- est_glmer_Increasing - 1.96 * se_glmer_Increasing
...
glmer_summary_Increasing <- data.frame(
  ...
  CI_Increasinger = round(plogis(ci_Increasinger_glmer_Increasing), 3),
...
# Compute 95% CI (logit scale)
ci_Higher_glmer_High <- est_glmer_High - 1.96 * se_glmer_High
...
glmer_summary_High <- data.frame(
  ...
  CI_Higher = round(plogis(ci_Higher_glmer_High), 3),
...
# Compute 95% CI (logit scale)
ci_Moderateer_glmer_Moderate <- est_glmer_Moderate - 1.96 * se_glmer_Moderate
...
glmer_summary_Moderate <- data.frame(
  ...
  CI_Moderateer = round(plogis(ci_Moderateer_glmer_Moderate), 3),
