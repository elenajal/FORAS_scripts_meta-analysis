...
Here we fit seperate binomial GLMMs (random intercept for `Study`) for the continuous and categorical moderators. For continuous moderators, we report the estimated prevalence at the reference (moderator = 0) and the marginal delta (approximate change in percentage points per 1‑unit increase). For categorical moderators, we report the estimated prevalence for the reference level and contrasted level(s).
...
# Helper: fit model for one predictor and return the key stats
...
fit_cat <- function(data, var, keep = NULL, ref = NULL,
  ...
  # Treatment coding: baseline = first level
...
The following describes the outcomes of the **continuous moderators** of the **Low Symptoms trajectory**. 
We report the estimated prevalence at the reference (moderator = 0) and the marginal delta (approximate change in percentage points per 1‑unit increase).
...
The folLowing describes the outcomes of the **categorical moderators** of the **Low Symptoms trajectory**. 
We report the estimated prevalence for the reference level and contrasted level(s), as well as the p-value for the difference in prevalence (Δ %).
...
### Continuous moderators
The following describes the outcomes of the **continuous moderators** of the **Decreasing Symptoms trajectory**. 
We report the estimated prevalence at the reference (moderator = 0) and the marginal delta (approximate change in percentage points per 1‑unit increase).
...
### Categorical moderators
The following describes the outcomes of the **categorical moderators** of the **Decreasing Symptoms trajectory**. 
We report the estimated prevalence for the reference level and contrasted level(s), as well as the p-value for the difference in prevalence (Δ %).
...
### Continuous moderators
The following describes the outcomes of the **continuous moderators** of the **Increasing Symptoms trajectory**. 
We report the estimated prevalence at the reference (moderator = 0) and the marginal delta (approximate change in percentage points per 1‑unit increase).
...
### Categorical moderators
The following describes the outcomes of the **categorical moderators** of the **Increasing Symptoms trajectory**. 
We report the estimated prevalence for the reference level and contrasted level(s), as well as the p-value for the difference in prevalence (Δ %).
...
### Continuous moderators
The following describes the outcomes of the **continuous moderators** of the **High Symptoms trajectory**. 
We report the estimated prevalence at the reference (moderator = 0) and the marginal delta (approximate change in percentage points per 1‑unit increase).
...
### Categorical moderators
The following describes the outcomes of the **categorical moderators** of the **High Symptoms trajectory**. 
We report the estimated prevalence for the reference level and contrasted level(s), as well as the p-value for the difference in prevalence (Δ %).
...
### Continuous moderators
The following describes the outcomes of the **continuous moderators** of the **Moderate Symptoms trajectory**. 
We report the estimated prevalence at the reference (moderator = 0) and the marginal delta (approximate change in percentage points per 1‑unit increase).
...
### Categorical moderators
The following describes the outcomes of the **categorical moderators** of the **Moderate Symptoms trajectory**. 
We report the estimated prevalence for the reference level and contrasted level(s), as well as the p-value for the difference in prevalence (Δ %).
...
# Tables for Paper
## Continuous Moderators Summary Table (Table 2)
...
# ---- build the combined table (same transformations as your Low chunk) ----
...
# ---- ensure UTF-8 like your Low chunk ----
...
tbl_all_utf8 %>%
  ...
  tab_header(title = "Continuous Moderators - All Trajectories") %>%
  cols_width(Predictor ~ px(220)) %>%
  cols_align(align = "center", columns = -Predictor) %>%
  cols_align(align = "left",   columns = Predictor) %>%
  tab_style(
