...
df_low$Low_n <-
  round((df_low$Low_rate / 100) * df_low$Sample_Size)
...
df_Decreasing$Decreasing_n <-
  round((df_Decreasing$Decreasing_rate / 100) * df_Decreasing$Sample_Size)
...
df_Increasing$Increasing_n <-
  round((df_Increasing$Increasing_rate / 100) * df_Increasing$Sample_Size)
...
df_High$High_rate <- (df_High$High_percentage) / 100

df_High <- df_High %>%
  filter(!is.na(High_rate))

# Calculate High_n as (percentage / 100) * sample size
df_High$High_n <-
  round((df_High$High_rate / 100) * df_High$Sample_Size)
...
df_Moderate <- df_Moderate %>%
  filter(!is.na(Moderate_rate))

# Calculate Moderate_n as (percentage / 100) * sample size
df_Moderate$Moderate_n <-
  round((df_Moderate$Moderate_rate / 100) * df_Moderate$Sample_Size)
