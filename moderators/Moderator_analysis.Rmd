...
diagnostic_gt_brms <- function(model,
  ...
  gt::gt(tab, rowname_col = "Predictor", groupname_col = "component") %>% # Initialize gt table with grouping
    gt::tab_header(
      title = paste0(title,
                     if (!is.null(model_name)) paste0(" — ", model_name) else "",
